...
public class DefaultStudySchema extends AbstractStudySchema {

    public DefaultStudySchema(Map<String, AbstractTask> tasksMap, List<Dependency> dependencies, AbstractTask rootTask) {
